...
from skimage.transform import AffineTransform, SimilarityTransform, ProjectiveTransform, warp
...
plt.figure();plt.imshow(dst_im)                         # plot src image
...
_stitch(dst_im,src_im,mask_idx=1,cval=0,show=True,tf_model=tf_model,n_keypoints=500,min_samples=4,residual_threshold=2)
